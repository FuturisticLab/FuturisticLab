// Projects data
    const projects = [
      ...
      },
      {
        ...
        description:
          'Secure cryptocurrency wallet with multi-chain support and zero-knowledge proofs',
      ...
      {
        title: 'Hologram API',
        description: '3D holographic projection API for next-gen interfaces',
        tech: ['WebGL', 'Holographics', 'JavaScript'],
        color: '#001aff',
      },
      {
        title: 'Quantum Sim',
        description: 'Quantum computing simulator running in browser with 1000+ qubits',
        tech: ['JavaScript', 'Quantum', 'WebAssembly'],
        color: '#3366ff',
      },
      {
        title: 'Neural Art',
        description: 'AI-powered generative art using consciousness algorithms',
        tech: ['TensorFlow.js', 'Canvas API', 'Neural'],
        color: '#00e6ff',
      },
      {
        title: 'Space Nav',
        description: 'Interstellar navigation system with wormhole detection',
        tech: ['Three.js', 'Physics', 'Astronomy'],
        color: '#0099cc',
      },
      {
        title: 'Mind Reader',
        description: 'EEG-controlled interface using brain-computer integration',
        tech: ['WebRTC', 'Signal Processing', 'ML'],
        color: '#00aaff',
      },
    ];
...
const articles = {
  'AI Chat Bot': {
    title: 'AI Chat Bot',
    body: `
      <p>Advanced conversational AI with natural language processing and quantum-enhanced responses.</p>
      <p>This project uses TensorFlow and Python to create a next-gen chatbot.</p>
    `,
    images: [
      { src: 'assets/images/Image_fx (18).jpg', caption: 'AI Chat Interface' },
      { src: 'assets/images/Image_fx (30).jpg', caption: 'Second AI UI View' }, // Added caption here
    ],
    ...
    githubLink: 'https://github.com/yourusername/ai-chat-bot',
      ...
      'Blockchain Wallet': {
        title: 'Blockchain Wallet',
        body: `
            <p>A secure cryptocurrency wallet supporting multi-chain assets and zero-knowledge proofs.</p>
            <p>Provides robust privacy and sync using Web3 and Ethereum.</p>
        `,
        images: [
          { src: 'https://i.imgur.com/1aX0nNv.jpg', caption: 'Wallet Dashboard' },
          { src: 'https://i.imgur.com/3JHu52L.jpg', caption: 'Transaction Signing Interface' },
        ],
